...
module.exports= async(obj)=>{
    try {
        ...
        const output = await  helper.mysqlHelper.query(`INSERT INTO teachers (uuid,firstName,lastName,age,email,contact,address,subject,createdAt) VALUES ('${uuidv4()}','${obj.firstName }','${obj.lastName}','${obj.age}','${obj.email}','${obj.contact}','${obj.address}','${obj.subject}',${myDate})`);
